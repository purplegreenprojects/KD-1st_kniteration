<?php
	...
	//colors
		...
		//Lion Brand Homespun Colors
			...
			$arrayhomespuncolors = array($arrayhepplewhite, $arrayclouds, $arrayedwardian, $arrayhblack, $arrayspice, $arraycream, $arrayrococo, $arraysierra, $arraybarley, $arraysanddune, $arraygolden);
		...
		//Premier Parfait Colors
			...
			$arrayparfaitcolors = array($arraypwhite, $arraypcream, $arraypblack, $arraylicorice, $arraycandycorn);
